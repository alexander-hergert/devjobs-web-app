...
export const jobs = [
  {
    ...
    requirements_list: `5+ years of industry experience in a software engineering role, preferably building a SaaS product. You can demonstrate significant impact that your work has had on the product and/or the team.##Experience with scalable distributed systems, both built from scratch as well as on AWS primitives.##Extremely data-driven.##Ability to debug complex systems.`,
    job_role:
  ...
  },
  {
    ...
    requirements_list: `You have a knack for UI design##Have Haskell or Purescript knowledge/hacking under your belt.##An experienced engineer familiar with automated testing and deployment.##Experienced with functional programming and domain-driven design or simply interested and capable of learning on the job.`,
    job_role:
      "The role is more frontend-focused where you will be tasked to build browser-based UIs for Haskell applications.",
    job_role_list: `Build up our tech stack around Haskell and introduce best practices##Contribute to the design of our conversational engine and the architecture supporting it##Design new UIs, working closely with users, stakeholders and the backend team.##Maximize robustness, performance, and scalability of solutions`,
  ...
  },
  {
    ...
    requirements_list: `Active participation on a software development team designing, coding, testing, and releasing functionality to our customers##Close collaboration with other engineers and product managers to become a valued member of an autonomous, cross-functional team##Operational responsibility for the services that are owned by your team, potentially including taking part in an on-call rotation`,
    job_role:
    ...
    job_role_list: `Design, code, deploy, and test applications according to the user stories/requirements and industry best practices.##Follow industry standard software lifecycle process when developing software##Conduct code-review with other developers##Assist in development and peer review of plans, technical solutions, and related documentation.`,
  ...
  },
  {
    ...
    requirements_list: `Expert Node.js proficiency in a production environment##Proficiency in developing REST APIs##Expert proficiency with relational databases (MySQL) and optimizing SQL queries##Extensive experience with microservices-based architecture in production##Experience with CircleCI, Jenkins or similar CI/CD applications`,
    job_role:
  ...
  },
  {
    ...
    requirements_list: `Bachelor's degree preferred, strong preference for Computer Science field of study##Minimum of 5 years of relevant work experience##Hands-on experience with configuring and maintaining resources on AWS##Experience and solid understanding to deploy and maintain container orchestration platforms such as ECS or Kubernetes##Knowledge of networking fundamentals##Expertise with cloud security, understand the principle of least privilege##Strong written and verbal communication skills`,
    job_role:
  ...
  },
  {
    ...
    requirements_list: `Strong programming skills in Objective-C and/or Swift##Previous experience developing mobile applications on iOS##Experience working closely across a variety of teams, including product management, design, and engineering##Knowledge of core CS concepts such as common data structures and algorithms, profiling, and optimization`,
    job_role:
    ...
    job_role_list: `Design and develop UI components that make feature development faster, baking in consistency and accessibility to the designs##Build frameworks and infrastructure to make product development faster, safer, and more consistent##Improve the performance and stability of the mobile app##Strive to keep the mobile codebase secure`,
  ...
  },
  {
    ...
    requirements_list: `Computer Science degree or equivalent##Experience with EJB, J2EE,Tomcat, JBoss andrelational databases such as MySQL, MSSQL, Oracle##At least three years of post-graduate experience##Deep understanding of OO programming principals and commitment to clean, efficient, well documented code.`,
    job_role:
    ...
    job_role_list: `Design and develop high-volume, low-latency applications that enhance Maker's core platform##Create well designed, testable, efficient code##Participate in all phases of the development lifecycle##Investigate alternatives and technologies and present them for architectural review, in order to support continuous improvement`,
  ...
  },
  {
    ...
    requirements_list: `4+ years of experience of Frontend Development##Expertise with React required##Expertise with Next.js, Apollo, Typescript, and GraphQL preferred`,
    job_role:
  ...
  },
  {
    ...
    requirements_list: `5-7 years of experience in infrastructure engineering of applications##Experience in web application security analysis and resolution.##Experience working within a modern Javascript workflow through technologies such as: GitHub, CSS Preprocessors, Styled Components, Single Page Application frameworks and Module Bundlers (Webpack etc.)##xperience in implementing A/B Tests##Hands on experience with React/Redux in a production application`,
    job_role:
    ...
    job_role_list: `Security audit of web application with an emphasis on commerce/transactional flows##Maintain and improve security skills, knowledge, and training through professional development, including participating in tech conferences and wider tech community forums##Work on a modern stack including React and Django.##Enforce code quality through test driven development via unit tests and automated tests.`,
  ...
  },
  {
    ...
    requirements_list: `Multiple years of React experience##Good eye for detail##Passion for great user experience and API design##Comfortable working with cross-functional and cross-cultural teams`,
    job_role:
    ...
    job_role_list: `Working with our team to build out our React/Typescript/GraphQL stack##Collaborating with product and design to increase conversions and improve user experience##Building new, efficient, and scalable front-end applications that will interface with public and internal APIs##Writing clean, maintainable, and testable code##Work with backend teams to solve complex problems`,
    company_website: "https://example.com/crowdfund",
  },
  {
    user_id: "Coffeeroasters",
    ...
    requirements_list: `A degree in Computer Science or an equivalent engineering foundation.##Experience in Python and/or JavaScript.##Ability to thrive in a fast-paced startup.##Someone who loves to learn and is passionate about helping others.`,
    job_role:
    ...
    job_role_list: `Write frontend code and build UI to implement new features. Includes taking in data from our API, structuring that data, and displaying it.##Build backend code for API.##Consistently improve our platform so we can deliver features quickly with high reliability and scalability.##Apply user experience methodology and best practices to translate user needs and business requirements into engaging user-centered design.##Write/maintain documentation for the client and other team members.`,
    company_website: "https://example.com/coffeeroasters",
  },
  {
    user_id: "Blogr",
    ...
    requirements_list: `Experience in JavaScript software development, preferably in a product company##Experience with React and state management libraries (such as Redux or Mobx)##Understand cross-browser compatibility issues and ways to work around them.##English language fluency, excellent communication skills`,
    job_role:
    ...
    job_role_list: `Help define our software engineering culture##Write high quality software for the frontend##Do code reviews##Proactively solve the problems most important to the business`,
    company_website: "https://example.com/blogr",
  },
];
